    ...
    public class ViewController : UIViewController
    {
        ...
        private void SetupSurface(SCIChartSurface surface)
        {
            ...
            using (surface.SuspendUpdates())
            {
                ...
                surface.ChartModifiers.Add(new SCIRolloverModifier { ReceiveHandledEvents = true, EventsGroupTag = "SharedEventGroup" });
                surface.ChartModifiers.Add(new SCIXAxisDragModifier());

...
| [SCIFreehandDrawingModifier](trading-annotation---scifreehanddrawingmodifier.html)                           | Provides a **crosshairs** with a tooltip and axis labels. See [Freehand Drawing Annotation](https://www.scichart.com/example/ios-macos-freehand-drawing-annotations-example/) example.                                                                                                                                                                                                                                                                  |
| [SCIFibonacciRetracementCreationModifier](trading-annotation---scifibonacciretracementcreationmodifier.html) | Enables interactive creation of a Fibonacci Retracement annotation by tapping/dragging to define two anchor points [Start, End]. Automatically divides the price range between them into Fibonacci ratio levels for identifying potential support and resistance zones. See the [Trading Annotation](https://www.scichart.com/example/ios-chart/ios-macos-trading-annotation-example/) example.                                                         |
| [SCIMeasureCreationModifier](trading-annotation---scimeasurecreationmodifier.html)                           | Enables interactive creation of a Measure annotation by tapping/dragging to define two anchor points [Start, End]. Automatically colours the zone as growing or declining based on the price direction between them and displays the scaled price/time distance, useful for gauging move size and volatility. See the [Trading Annotation](https://www.scichart.com/example/ios-chart/ios-macos-trading-annotation-example/) example.                   |
| [SCIStopLossTakeProfitCreationModifier](trading-annotation---scistoplosstakeprofitcreationmodifier.html)     | Enables interactive creation of a Stop Loss / Take Profit annotation by tapping/dragging to define two anchor points [Start, End]. Automatically colours the zone as a take-profit or stop-loss region based on the price direction between them, with optional axis labels for marking risk/reward relative to an entry price. See the [Trading Annotation](https://www.scichart.com/example/ios-chart/ios-macos-trading-annotation-example/) example. |
